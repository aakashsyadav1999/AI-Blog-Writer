...
export function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      {/* Gradient Orbs */}
      <motion.div
        className="absolute top-0 -left-20 w-96 h-96 bg-gradient-to-br from-emerald-300/30 to-teal-400/30 rounded-full blur-3xl"
        animate={{
          x: [0, 100, 0],
          y: [0, 50, 0],
          scale: [1, 1.1, 1],
      ...
      <motion.div
        className="absolute top-1/4 -right-20 w-[500px] h-[500px] bg-gradient-to-br from-green-300/20 to-emerald-400/20 rounded-full blur-3xl"
        animate={{
          x: [0, -80, 0],
          y: [0, 100, 0],
          scale: [1, 1.2, 1],
      ...
      <motion.div
        className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-gradient-to-br from-teal-300/25 to-green-400/25 rounded-full blur-3xl"
        animate={{
          x: [0, 60, 0],
          y: [0, -80, 0],
          scale: [1, 1.15, 1],
      ...
      {/* Organic Shapes */}
      <motion.div
        className="absolute top-1/3 left-1/3 w-64 h-64 opacity-20"
        animate={{
          rotate: 360,
        }}
        transition={{
